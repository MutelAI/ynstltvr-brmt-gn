...
@Component({
  ...
  template: `
    <section
      id="hero"
      [class]="'relative overflow-hidden bg-gradient-to-br from-blue-900 via-blue-800 to-teal-900 flex items-center ' + (biz.design().hero_layout === 'minimal' ? 'min-h-[70vh] items-end' : 'justify-center min-h-screen')"
      [attr.dir]="i18n.dir()"
    >
      <!-- ═══ Background patterns ═══ -->
